...
baseOutDir = 'results/Jan2025_HNL2016postVFP/tnpEleID/'
...
samplesDef = {
    'data'   : tnpSamples.Jan2025_HNL2016postVFP['data_Run2016F'].clone(),
    'mcNom'  : tnpSamples.Jan2025_HNL2016postVFP['DY_powheg'].clone(),
    'mcAlt'  : tnpSamples.Jan2025_HNL2016postVFP['DY_amcatnlo'].clone(),
    'tagSel' : tnpSamples.Jan2025_HNL2016postVFP['DY_powheg'].clone(),
}

## can add data sample easily
samplesDef['data'].add_sample( tnpSamples.Jan2025_HNL2016postVFP['data_Run2016G'] )
samplesDef['data'].add_sample( tnpSamples.Jan2025_HNL2016postVFP['data_Run2016H'] )
...
if not samplesDef['mcAlt' ] is None: samplesDef['mcAlt' ].set_weight(weightName)
if not samplesDef['tagSel'] is None: samplesDef['tagSel'].set_weight(weightName)
if not samplesDef['mcNom' ] is None: samplesDef['mcNom' ].set_puTree('/gv0/DATA/SKFlat/Run2UltraLegacy_v3/2016postVFP/MC_SkimTree_EGammaTnP_HEEP/DYJetsToEE_M-50_massWgtFix_TuneCP5_13TeV-powhegMiNNLO-pythia8-photos/DYJetsToEE_M-50_massWgtFix_2016b_2025_01_03_050234.root')
if not samplesDef['mcAlt' ] is None: samplesDef['mcAlt' ].set_puTree('/gv0/DATA/SKFlat/Run2UltraLegacy_v3/2016postVFP/MC_SkimTree_EGammaTnP_HEEP/DYJetsToLL_M-50_TuneCP5_13TeV-amcatnloFXFX-pythia8/DYJetsToLL_M-50_amcatnlo_2016b_2025_01_03_050234.root')
if not samplesDef['tagSel'] is None: samplesDef['tagSel'].set_puTree('/gv0/DATA/SKFlat/Run2UltraLegacy_v3/2016postVFP/MC_SkimTree_EGammaTnP_HEEP/DYJetsToEE_M-50_massWgtFix_TuneCP5_13TeV-powhegMiNNLO-pythia8-photos/DYJetsToEE_M-50_massWgtFix_2016b_2025_01_03_050234.root')
