...
eosUL2017 = '/data6/Users/jihkim/tnp_tamsa/POG_tree/2017/'
...
SKFlat_data_2017 = '/gv0/DATA/SKFlat/Run2UltraLegacy_v3/2017/DATA_SkimTree_EGammaTnP/SingleElectron/'
...
SKFlat_new_mg_2017 = '/gv0/DATA/SKFlat/Run2UltraLegacy_v3/2017/MC_SkimTree_EGammaTnP_HEEP/DYJetsToLL_M-50_TuneCP5_13TeV-madgraphMLM-pythia8/2024_09_21_210546/'
SKFlat_new_amc_2017 = '/gv0/DATA/SKFlat/Run2UltraLegacy_v3/2017/MC_SkimTree_EGammaTnP_HEEP/DYJetsToLL_M-50_TuneCP5_13TeV-amcatnloFXFX-pythia8/2024_09_21_210546/'

SKFlat_new_data_2018 = '/gv0/DATA/SKFlat/Run2UltraLegacy_v3/2018/DATA_SkimTree_EGammaTnP_HEEP/EGamma/'
SKFlat_new_mg_2018 = '/gv0/DATA/SKFlat/Run2UltraLegacy_v3/2018/MC_SkimTree_EGammaTnP_HEEP/DYJetsToLL_M-50_TuneCP5_13TeV-madgraphMLM-pythia8/2024_09_21_210546/'
SKFlat_new_amc_2018 = '/gv0/DATA/SKFlat/Run2UltraLegacy_v3/2018/MC_SkimTree_EGammaTnP_HEEP/DYJetsToLL_M-50_TuneCP5_13TeV-amcatnloFXFX-pythia8/2024_09_21_210546/'
...
#                                       isMC = True, nEvts =  -1 ),
    ...
    'data_Run2017B' : tnpSample('data_Run2017B' , SKFlat_new_data_2017 + 'periodB/2024_09_20_184353/SKFlatNtuple_2017_DATA_*.root' , lumi = 4.793961427),
    'data_Run2017C' : tnpSample('data_Run2017C' , SKFlat_new_data_2017 + 'periodC/2024_09_20_184353/SKFlatNtuple_2017_DATA_*.root' , lumi = 9.631214821 ),
    'data_Run2017D' : tnpSample('data_Run2017D' , SKFlat_new_data_2017 + 'periodD/2024_09_20_184353/SKFlatNtuple_2017_DATA_*.root' , lumi = 4.247682053 ),
    'data_Run2017E' : tnpSample('data_Run2017E' , SKFlat_new_data_2017 + 'periodE/2024_09_20_184353/SKFlatNtuple_2017_DATA_*.root' , lumi = 9.313642402 ),
    'data_Run2017F' : tnpSample('data_Run2017F' , SKFlat_new_data_2017 + 'periodF/2024_09_20_184353/SKFlatNtuple_2017_DATA_*.root' , lumi = 13.510934811),
...
HNL2018 = { #JH
    ### MiniAOD TnP for IDs scale factors
    'DY_madgraph'              : tnpSample('DY_madgraph',
                                       SKFlat_new_mg_2018 + 'SKFlatNtuple_2018_MC_*.root ',
                                       isMC = True, nEvts =  -1 ),
    'DY_amcatnloext'                 : tnpSample('DY_amcatnloext',
                                       SKFlat_new_amc_2018 + 'SKFlatNtuple_2018_MC_*.root',
                                       isMC = True, nEvts =  -1 ),

    'data_Run2018A' : tnpSample('data_Run2018A' , SKFlat_new_data_2018 + 'periodA/2024_09_21_003357/SKFlatNtuple_2018_DATA_*.root' , lumi = 10.723 ),
    'data_Run2018B' : tnpSample('data_Run2018B' , SKFlat_new_data_2018 + 'periodB/2024_09_21_003357/SKFlatNtuple_2018_DATA_*.root' , lumi = 5.964  ),
    'data_Run2018C' : tnpSample('data_Run2018C' , SKFlat_new_data_2018 + 'periodC/2024_09_21_003357/SKFlatNtuple_2018_DATA_*.root' , lumi = 6.382  ),
    'data_Run2018D' : tnpSample('data_Run2018D' , SKFlat_new_data_2018 + 'periodD/2024_09_21_003357/SKFlatNtuple_2018_DATA_*.root' , lumi = 29.181 ),
...
#                                       isMC = True, nEvts =  -1 ),
    ...
    'data_Run2017'  : tnpSample('data_Run2017'  , eosUL2017 + 'SingleEle_RunBCDEF.root' , lumi = 41.7), #JH
