...
#python create-batch.py -c ID -e 2016preVFP -f passingHNLMVA
#python create-batch.py -c ID -e 2016postVFP -f passingHNLMVA
#python create-batch.py -c Trig -e 2016preVFP 2016postVFP 2017 2018 -f HLTEl23 HLTEl12

python create-batch.py -c Jan2025_ID  -e 2016preVFP -f passingHNLMVA
